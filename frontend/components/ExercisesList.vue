<template>
  <div class="flex flex-col gap-2 w-full max-w-2xl">
    <div v-if="exercises.tests && typeof exercises.tests !== 'string'" class="flex items-center gap-4 p-4 w-full rounded-md bg-slate-50" v-for="exercise in exercises.tests">
